...
abstract class BaseOption extends BaseObject  implements Persistent
{
	...
	public function setItemId($v)
	{
		...
		if ($this->item_id !== $v) {
			$this->item_id = $v;
			$this->modifiedColumns[] = OptionPeer::ITEM_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = OptionPeer::USER_ID;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = OptionPeer::PRICE;
		}
	...
	public function setCreated($v)
	{
		...
		if ( $this->created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = OptionPeer::CREATED;
			}
	...
	public function setSoldOut($v)
	{
		...
		if ($this->sold_out !== $v || $this->isNew()) {
			$this->sold_out = $v;
			$this->modifiedColumns[] = OptionPeer::SOLD_OUT;
		}
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v) {
			$this->quantity = $v;
			$this->modifiedColumns[] = OptionPeer::QUANTITY;
		}
	...
	public function setSold($v)
	{
		...
		if ($this->sold !== $v || $this->isNew()) {
			$this->sold = $v;
			$this->modifiedColumns[] = OptionPeer::SOLD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = OptionPeer::NUM_COLUMNS - OptionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OptionPeer::ITEM_ID)) $criteria->add(OptionPeer::ITEM_ID, $this->item_id);
		if ($this->isColumnModified(OptionPeer::USER_ID)) $criteria->add(OptionPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(OptionPeer::PRICE)) $criteria->add(OptionPeer::PRICE, $this->price);
		if ($this->isColumnModified(OptionPeer::CREATED)) $criteria->add(OptionPeer::CREATED, $this->created);
		if ($this->isColumnModified(OptionPeer::SOLD_OUT)) $criteria->add(OptionPeer::SOLD_OUT, $this->sold_out);
		if ($this->isColumnModified(OptionPeer::QUANTITY)) $criteria->add(OptionPeer::QUANTITY, $this->quantity);
		if ($this->isColumnModified(OptionPeer::SOLD)) $criteria->add(OptionPeer::SOLD, $this->sold);
	 ...
	 * If this Option is new, it will return
	 ...
	 * Otherwise if this Option is new, it will return
	 * an empty collection; or if this Option has previously
	 * been saved, it will retrieve related Purchases from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Option.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
